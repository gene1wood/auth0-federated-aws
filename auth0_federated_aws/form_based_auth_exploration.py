...
idp_entry_url = 'https://auth-dev.mozilla.auth0.com/samlp/AguzdHtOAZqbB85xAnrmYzMdYXAdUJDT'
...
# Opens the initial IdP url and follows all of the HTTP 302 redirects, and
...
form_soup = BeautifulSoup(form_response.text.decode('utf8'))
payload = {}
